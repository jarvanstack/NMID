...
import Git.GitHub.NMID.week_04.programmingWork.Recieve;
import Git.GitHub.NMID.week_04.programmingWork.Send;
...
public class User {
    ...
    private void sendBasicInformationToServer() {
        ...
        executorService.submit(new Git.GitHub.NMID.week_04.programmingWork.Send(messageTotal.getBytes(), this.sendPort));
    }
