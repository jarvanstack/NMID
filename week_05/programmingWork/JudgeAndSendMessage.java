...
import Git.GitHub.NMID.week_04.programmingWork.Server;
import Git.GitHub.NMID.week_04.programmingWork.ServerSend;
...
private byte[] bytes ;
    ...
    public void run() {
        ...
        if (split[4].contains("basicInformation")){
            ...
            Git.GitHub.NMID.week_04.programmingWork.Server.users.put(++Git.GitHub.NMID.week_04.programmingWork.Server.countUser,split[0]+"@"+split[1]+"@"+split[2]);
            ...
            for (Integer key : Git.GitHub.NMID.week_04.programmingWork.Server.users.keySet()) {
                String[] users = Git.GitHub.NMID.week_04.programmingWork.Server.users.get(key).split("@");
            ...
            for (Integer key : Git.GitHub.NMID.week_04.programmingWork.Server.users.keySet()) {
                String[] users = Git.GitHub.NMID.week_04.programmingWork.Server.users.get(key).split("@");
                Git.GitHub.NMID.week_04.programmingWork.Server.executorService.submit(new Git.GitHub.NMID.week_04.programmingWork.ServerSend(users[0],//遍历所有人的ip
        ...
        //(2)删除用户
            ...
            //遍历map
            for (Integer integer : Git.GitHub.NMID.week_04.programmingWork.Server.users.keySet()) {
                //删除用户
                if (Git.GitHub.NMID.week_04.programmingWork.Server.users.get(integer).contains(split[2])){
                    Git.GitHub.NMID.week_04.programmingWork.Server.users.remove(integer);
        ...
        //（4）私发
            ...
            for (Integer key : Git.GitHub.NMID.week_04.programmingWork.Server.users.keySet()) {
                if (key.toString().contains(split[4])) {
                    ...
                    Git.GitHub.NMID.week_04.programmingWork.Server.executorService.submit(new Git.GitHub.NMID.week_04.programmingWork.ServerSend(users[0],
